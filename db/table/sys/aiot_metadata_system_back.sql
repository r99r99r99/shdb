...
Date: 2018-05-04 14:44:55
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for aiot_metadata_system_back
-- ----------------------------
DROP TABLE IF EXISTS `aiot_metadata_system_back`;
CREATE TABLE `aiot_metadata_system_back` (
